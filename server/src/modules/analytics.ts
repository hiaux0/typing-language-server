import { TypingAnalytics, TypingAnalyticsMap, TypoAnalytics } from "../types/types";

let currentWord: string | undefined = '';

export function getWordsFromAnalytics(analyticsMap: TypingAnalyticsMap, word: string): string[] {
